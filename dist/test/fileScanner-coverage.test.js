...
describe("FileScanner Coverage Tests - Targeting Specific Uncovered Lines", () => {
    ...
    beforeEach(async () => {
        ...
        vi.mocked(fg.default).mockResolvedValue(['/test/file1.js', '/test/file2.js', '/test/file3.js']);
    });
    afterEach(() => {
        vi.doUnmock("eslint");
        vi.resetModules();
    ...
    it("should trigger lines 147-152: debug logging when calculateConfigForFile fails", async () => {
        ...
        const mockESLint = {
            calculateConfigForFile: vi.fn().mockRejectedValue(new Error("Config calculation failed")),
        ...
        const { FileScanner } = await import("../lib/fileScanner.js"), scanner = new FileScanner(mockLogger), 
...
//# sourceMappingURL=fileScanner-coverage.test.js.map