    ...
    describe("loadConfig", () => {
        describe("JSON config files", () => {
            ...
            it("should throw error for invalid JSON", async () => {
                ...
                await expect(loadConfig(configPath, "/project")).rejects.toThrow(
        ...
        describe("JavaScript/TypeScript config files", () => {
            ...
            const writeTemp = async (fileName: string, contents: string): Promise<string> => {
        ...
        describe("error handling", () => {
            ...
            it("should throw error for import failures", async () => {
                ...
                (globalThis as any).import = vi.fn().mockRejectedValue(new Error("Module not found"));

                await expect(loadConfig(configPath, "/project")).rejects.toThrow(
                    "Failed to load JS/TS config"
                );
            });
        });
